...
for i, (ot1, ot2) in enumerate(type_pairs):
    ...
    for o1, o2 in object_pairs:
        ...
        events = parse_to_2d_list(result, 'e.ID', 'e.timestamp')
...
# get all event ids + timestamp for each object pair
def get_events_for_object_pair_query(o1, o2):
    return
